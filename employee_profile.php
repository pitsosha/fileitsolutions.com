...
<body>
	...
	<div class="col-md-4">
		<?php
			$query = mysqli_query($conn, "SELECT * FROM `employee` WHERE `emp_no` = '$_SESSION[employee]'") or die(mysqli_error());
		...
		<div class="panel panel-default" style="background-color:#393f4d;" id="panel-margin">
			<div class="panel-heading" style="background-color:#feda6a;">
				<center><h1 class="panel-title" style="color:red;">User Profile</h1></center>
			</div>
			<div class="panel-body">
				<h4 style="color:#fff;">User no: <label class="pull-right"><?php echo $fetch['emp_no']?></label></h4>
				...
				<h4 style="color:#fff;">Department: <label class="pull-right"><?php echo $fetch['yr&sec']?></label></h4>
		...
		<div class="panel panel-default" style="margin-top:100px;">
			<div class="panel-body">
				<table id="table" class="table table-bordered">
					...
					<tbody>
						<?php
							$stud_no = $fetch['emp_no'];
							$query = mysqli_query($conn, "SELECT * FROM `storage` WHERE `emp_no` = '$stud_no'") or die(mysqli_error());
